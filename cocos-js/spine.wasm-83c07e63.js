System.register(['./_virtual_cc-30f7f22e.js'], function (exports) {
  'use strict'
        ...
        (function () {
          ...
          return function (spineWasm) {
              ...
              whenDependentTypesAreResolved(
                ...
                function (base) {
                  ...
                  if (registeredClass.baseClass) {
                    if (
                      registeredClass.baseClass.__derivedClasses === undefined
                    ) {
                      ...
                      if (classType.registeredClass.__derivedClasses) {
                        for (
                          var _iterator = _createForOfIteratorHelperLoose(
                              classType.registeredClass.__derivedClasses
                            ),
                            _step;
                          ...
                          if (
                            !derivedClass.constructor.hasOwnProperty(methodName)
                          ) {
                    ...
                    function (fieldType) {
                      ...
                      if (setter) {
                        ...
                        desc.set = function (v) {
                          ...
                          setter(
                            rawFieldPtr,
                            fieldType['toWireType'](destructors, v)
                          )
                          runDestructors(destructors)
                        }
                      }
            ...
            function __embind_register_integer(
              ...
              var checkAssertions = function checkAssertions(
                value,
                toTypeName
              ) {}
              var toWireType
            ...
            function _spineListenerCallBackFromJS() {
              ...
              globalThis.TrackEntryListeners.emitListener(
                listenerID,
                trackEntry,
                event
              )
