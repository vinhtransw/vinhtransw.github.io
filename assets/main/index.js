System.register(
  'chunks:///_virtual/AdditionMoneyController.ts',
  ...
  function (exports) {
    ...
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          '74073kkBu1Ato4ceZaCjtj0',
          'AdditionMoneyController',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var AdditionMoneyController = exports(
          'AdditionMoneyController',
          ((_dec = ccclass('AdditionMoneyController')),
          (_dec2 = property({
            type: CCInteger
          })),
          _dec(
            (_class =
              ((_class2 = /*#__PURE__*/ (function (_Component) {
...
System.register(
  'chunks:///_virtual/BoundingGiftController.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc'],
  function (exports) {
    var _applyDecoratedDescriptor,
      _inheritsLoose,
    ...
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          'b0978iMBKNEC7dwXxLZAIZN',
          'BoundingGiftController',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var BoundingGiftController = exports(
          'BoundingGiftController',
          ((_dec = ccclass('BoundingGiftController')),
          (_dec2 = property({
            type: CCInteger
          })),
          (_dec3 = property({
            ...
            (_class =
              ((_class2 = /*#__PURE__*/ (function (_Component) {
                ...
                _proto.start = function start() {
                  ...
                  var contentsize =
                    this.boundingNode.getComponent(UITransform).contentSize
  ...
  function (exports) {
    ...
    return {
      ...
      execute: function () {
        ...
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var DebugViewRuntimeControl = exports(
          'DebugViewRuntimeControl',
          ((_dec = ccclass('internal.DebugViewRuntimeControl')),
          (_dec2 = property(Node)),
          (_dec3 = property(Node)),
          (_dec4 = property(Node)),
          _dec(
            (_class =
              ((_class2 = /*#__PURE__*/ (function (_Component) {
                ...
                _proto.start = function start() {
                  ...
                  for (var i = 0; i < 2; i++) {
                    var newLabel = instantiate(
                      this.EnableAllCompositeModeButton.getChildByName('Label')
                    )
                    newLabel.setPosition(
                      x + (i > 0 ? 50 + width * 2 : 150),
                      y,
                      0.0
                    )
                  ...
                  for (
                    ...
                    var newNode = _i
                      ? instantiate(this.singleModeToggle)
                    ...
                    this.textComponentList[this.textComponentList.length] =
                      textComponent
                  ...
                  this.labelComponentList[this.labelComponentList.length] =
                    labelComponent
                  var changeColorButton = instantiate(
                    this.EnableAllCompositeModeButton
                  )
                  changeColorButton.setPosition(x + 90, y, 0.0)
                  changeColorButton.setScale(0.5, 0.5, 0.5)
                  changeColorButton.on(
                    Button.EventType.CLICK,
                  ...
                  labelComponent =
                    changeColorButton.getComponentInChildren(Label)
                  labelComponent.string = 'TextColor'
                  this.labelComponentList[this.labelComponentList.length] =
                    labelComponent
                  var HideButton = instantiate(
                    this.EnableAllCompositeModeButton
                  )
                  ...
                  for (var _i2 = 0; _i2 < this.strMisc.length; _i2++) {
                    ...
                    var _textComponent =
                      _newNode.getComponentInChildren(RichText)
                    _textComponent.string = this.strMisc[_i2]
                    this.textComponentList[this.textComponentList.length] =
                      _textComponent
                    this.textContentList[this.textContentList.length] =
                      _textComponent.string
                  ...
                  for (var _i3 = 0; _i3 < this.strComposite.length; _i3++) {
                    var _newNode2 = _i3
                      ? instantiate(this.compositeModeToggle)
                      : this.compositeModeToggle
                    _newNode2.setPosition(x, y - height * _i3, 0.0)
                    _newNode2.setScale(0.5, 0.5, 0.5)
                    _newNode2.parent = this.compositeModeToggle.parent
                    var _textComponent2 =
                      _newNode2.getComponentInChildren(RichText)
                    _textComponent2.string = this.strComposite[_i3]
                    this.textComponentList[this.textComponentList.length] =
                      _textComponent2
                    this.textContentList[this.textContentList.length] =
                      _textComponent2.string
                    _newNode2.on(
                      Toggle.EventType.TOGGLE,
                ...
                _proto.isTextMatched = function isTextMatched(
                  textUI,
                  textDescription
                ) {
                ...
                _proto.toggleCompositeMode = function toggleCompositeMode(
                  toggle
                ) {
                  var debugView = director.root.debugView
                  var textComponent = toggle.getComponentInChildren(RichText)
                ...
                _proto.toggleLightingWithAlbedo =
                  function toggleLightingWithAlbedo(toggle) {
                    var debugView = director.root.debugView
                    debugView.lightingWithAlbedo = toggle.isChecked
                  }
                _proto.toggleCSMColoration = function toggleCSMColoration(
                  toggle
                ) {
                  var debugView = director.root.debugView
                  debugView.csmLayerColoration = toggle.isChecked
                }
                _proto.enableAllCompositeMode = function enableAllCompositeMode(
                  button
                ) {
                  var debugView = director.root.debugView
                  ...
                  for (
                    var i = 0;
                    i < this.compositeModeToggleList.length;
                    i++
                  ) {
                    var _toggleComponent =
                      this.compositeModeToggleList[i].getComponent(Toggle)
                    _toggleComponent.isChecked = true
                  }
                  var toggleComponent =
                    this.miscModeToggleList[0].getComponent(Toggle)
                  toggleComponent.isChecked = false
                  debugView.csmLayerColoration = false
                  toggleComponent =
                    this.miscModeToggleList[1].getComponent(Toggle)
                ...
                _proto.hideUI = function hideUI(button) {
                  ...
                  this.hideButtonLabel.string = activeValue
                    ? 'Hide UI'
                    : 'Show UI'
                }
                _proto.changeTextColor = function changeTextColor(button) {
                  ...
                  for (
                    var _i4 = 0;
                    _i4 < this.labelComponentList.length;
                    _i4++
                  ) {
                    this.labelComponentList[_i4].color =
...
System.register(
  'chunks:///_virtual/EntryScene.ts',
  [
    './rollupPluginModLoBabelHelpers.js',
    'cc',
    './SceneManagerComponent.ts',
    './GameDirector.ts',
    './SoundManagerComponent.ts',
    './TerrainManagerComponent.ts',
    './NetworkManagerComponent.ts'
  ],
  function (exports) {
    var _applyDecoratedDescriptor,
      _inheritsLoose,
    ...
    return {
      ...
      execute: function () {
        ...
        var EntryScene = exports(
          'EntryScene',
          ((_dec = ccclass('EntryScene')),
          (_dec2 = property({
            type: CCBoolean,
            visible: true
          })),
              ...
              ((_class2 = /*#__PURE__*/ (function (_Component) {
                ...
                _proto.start = function start() {
                  ...
                  if (this._terrainManager) {
                    ...
                    var myComp = terrainManagerNode.addComponent(
                      TerrainManagerComponent
                    )
                    var monoConfig = {
                      configPath: this._terrainManagerConfigPath
                    }
                    GameDirector.TerrainManager().initialize(
                      monoConfig,
                  ...
                  if (this._sceneManager) {
                    ...
                    var _myComp = sceneManagerNode.addComponent(
                      SceneManagerComponent
                    )
                    var _monoConfig = {
                      configPath: this._sceneManagerConfigPath
                    }
                    GameDirector.SceneManager().initialize(
                      _monoConfig,
                      this.initialized.bind(this)
                    )
                  ...
                  if (this._soundManager) {
                    ...
                    var _myComp2 = soundManagerNode.addComponent(
                      SoundManagerComponent
                    )
                    var _monoConfig2 = {
                      configPath: this._soundManagerConfigPath
                    }
                    GameDirector.SoundManager().initialize(
                      _monoConfig2,
                      this.initialized.bind(this)
                    )
                  ...
                  if (this._networkManager) {
                    ...
                    var _myComp3 = networkManagerNode.addComponent(
                      NetworkManagerComponent
                    )
                    var _monoConfig3 = {
                      configPath: this._networkManagerConfigPaht
                    }
                    GameDirector.NetworkManager().initialize(
                      _monoConfig3,
                      this.initialized.bind(this)
                    )
...
System.register(
  'chunks:///_virtual/GameDirector.ts',
  [
    'cc',
    './SceneManager.ts',
    './SoundManager.ts',
  ...
  function (exports) {
    ...
    return {
      ...
      execute: function () {
        cclegacy._RF.push(
          {},
          'bb220cZsUVHPJ6faDlN7ILr',
          'GameDirector',
          undefined
        )
        var GameDirector = exports(
          'GameDirector',
          /*#__PURE__*/ (function () {
...
System.register(
  'chunks:///_virtual/GamercialSceneController.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc'],
  function (exports) {
    ...
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          '59e46LdvdpBaJUx/PjKgWa0',
          'GamercialSceneController',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var GamercialSceneController = exports(
          'GamercialSceneController',
          ((_dec = ccclass('GamercialSceneController')),
          _dec(
...
System.register(
  'chunks:///_virtual/GraphQlQuery.ts',
  ['cc'],
  function (exports) {
    var cclegacy
    return {
      ...
      execute: function () {
        cclegacy._RF.push(
          {},
          'a95d12FVaNIl7pD3/E5YCVG',
          'GraphQlQuery',
          undefined
        )
        var GraphQlQuery = exports(
          'GraphQlQuery',
          function GraphQlQuery(query, variable, files) {
            this._query = void 0
...
System.register(
  'chunks:///_virtual/HomeCanvasController.ts',
  [
    './rollupPluginModLoBabelHelpers.js',
    'cc',
    './GameDirector.ts',
    './AdditionMoneyController.ts'
  ],
  function (exports) {
    var _applyDecoratedDescriptor,
      _initializerDefineProperty,
    ...
    return {
      ...
      execute: function () {
        ...
        var MonsterInfo = exports(
          'MonsterInfo',
          ((_dec4 = ccclass('MonsterInfo')),
          (_dec5 = property({
            type: Label
          })),
          (_dec6 = property({
        ...
        var BottomBar = exports(
          'BottomBar',
          ((_dec14 = ccclass('BottomBar')),
          (_dec15 = property({
            type: Node
          })),
          (_dec16 = property({
        ...
        var BootersInfo = exports(
          'BootersInfo',
          ((_dec18 = ccclass('BootersInfo')),
          (_dec19 = property({
            type: RichText
          })),
          (_dec20 = property({
        ...
        var BootersPanel = exports(
          'BootersPanel',
          ((_dec23 = ccclass('BootersPanel')),
          (_dec24 = property({
            type: BootersInfo
          })),
          _dec23(
            (_class16 =
              ((_class17 = function BootersPanel() {
        ...
        var HomeCanvasController = exports(
          'HomeCanvasController',
          ((_dec25 = ccclass('HomeCanvasController')),
          (_dec26 = property({
            type: UserInfo
          })),
          (_dec27 = property({
          ...
          _dec25(
            (_class19 =
              ((_class20 = /*#__PURE__*/ (function (_Component) {
                ...
                _proto.setPlayerInfo = function setPlayerInfo(player) {
                  ...
                  this.currentcy.goldAmount.string = player.currentMoney
                    .toFixed(0)
                    .toString()
                ...
                _proto.setGameInfo = function setGameInfo(game) {
                  this.monsterInfos.hp.string = game.currentHp
                    .toFixed(0)
                    .toString()
                  this.monsterInfos.exp.string = game.currentExp
                    .toFixed(0)
                    .toString()
                  this.monsterInfos.maxHp.string = game.maxHp
                    .toFixed(0)
                    .toString()
                  this.monsterInfos.maxExp.string = game.nextExp
                    .toFixed(0)
                    .toString()
                  this.monsterInfos.expBar.progress =
                    game.currentExp / game.nextExp
                  this.bootersPanel.booster[0].title.string =
                    '<color=#C9C9C9>Increase income by </color><color=#C4CC62>' +
                    (game.incomeBoost * 100).toFixed(0) +
                    '%</color>'
                  this.bootersPanel.booster[0].cost.string =
                    game.incomeBoostCost.toFixed(0).toString()
                  this.bootersPanel.booster[1].title.string =
                    '<color=#C9C9C9>Increase speed by </color><color=#C4CC62>' +
                    game.increaseSpeedBoost.toFixed(1) +
                    '%</color>'
                  this.bootersPanel.booster[1].cost.string =
                    game.increaseSpeedBoostCost.toFixed(0).toString()
                  this.bootersPanel.booster[2].title.string =
                    '<color=#C9C9C9>Increase recover by </color><color=#C4CC62>' +
                    game.recoveryBoost.toFixed(1) +
                    '%</color>'
                  this.bootersPanel.booster[2].cost.string =
                    game.recoverBoostCost.toFixed(0).toString()
                }
                _proto.increaseMoneyBy = function increaseMoneyBy(addition) {
                  var adm = instantiate(this.currentcy.additionCoin)
                  adm.getComponent(AdditionMoneyController).additionMoney =
                    addition
                ...
                _proto.checkBoosterAvailable =
                  function checkBoosterAvailable() {
                    this.bootersPanel.booster[0].updateButton.interactable =
                      this._playerData.currentMoney >=
                      this._playerData.gameData.incomeBoostCost
                    this.bootersPanel.booster[1].updateButton.interactable =
                      this._playerData.currentMoney >=
                      this._playerData.gameData.increaseSpeedBoostCost
                    this.bootersPanel.booster[2].updateButton.interactable =
                      this._playerData.currentMoney >=
                      this._playerData.gameData.recoverBoostCost
                  }
                ...
                _proto.updateIncomeButtonDown =
                  function updateIncomeButtonDown() {
                    this.onBoostUpdate(0)
                    this.checkBoosterAvailable()
                  }
                _proto.updateSpeedButtonDown =
                  function updateSpeedButtonDown() {
                    this.onBoostUpdate(1)
                    this.checkBoosterAvailable()
                  }
                _proto.updateRecoverButtonDown =
                  function updateRecoverButtonDown() {
                    this.onBoostUpdate(2)
                    this.checkBoosterAvailable()
                  }
...
System.register(
  'chunks:///_virtual/HomeLogic.ts',
  ['cc', './Player.ts', './Game.ts', './GameDirector.ts'],
  function (exports) {
        ...
        var HomeLogic = exports(
          ...
          /*#__PURE__*/ (function () {
            ...
            _proto.doEarn = function doEarn() {
              var _this3 = this
              return new Promise(function (resolve, reject) {
                _this3.player.currentMoney =
                  _this3.player.currentMoney +
                  _this3.player.currentIncome +
                  _this3.player.gameData.incomeBoost
                _this3.player.gameData.currentExp =
                  _this3.player.gameData.currentExp + 1
                _this3.player.gameData.currentHp =
                  _this3.player.gameData.currentHp - 0.5
                if (
                  _this3.player.gameData.currentExp >=
                  _this3.player.gameData.nextExp
                ) {
                  _this3.player.gameData.currentExp = 0
                  _this3.player.gameData.nextExp *= 1.5
                  _this3.player.level += 1
                  _this3.player.gameData.currentHp =
                    _this3.player.gameData.maxHp
            ...
            _proto.recover = function recover() {
              var _this4 = this
              return new Promise(function (resolve, reject) {
                _this4.player.gameData.currentHp = Math.max(
                  _this4.player.gameData.currentHp +
                    1 * _this4.player.gameData.recoveryBoost,
                  _this4.player.gameData.maxHp
                )
            ...
            _proto.doBoost = function doBoost(type) {
              ...
              return new Promise(function (resolve, reject) {
                if (
                  type == 0 &&
                  _this5.player.currentMoney >
                    _this5.player.gameData.incomeBoostCost
                ) {
                  _this5.player.currentMoney =
                    _this5.player.currentMoney -
                    _this5.player.gameData.incomeBoostCost
                ...
                if (
                  type == 1 &&
                  _this5.player.currentMoney >
                    _this5.player.gameData.increaseSpeedBoost
                ) {
                  _this5.player.currentMoney =
                    _this5.player.currentMoney -
                    _this5.player.gameData.increaseSpeedBoostCost
                ...
                if (
                  type == 2 &&
                  _this5.player.currentMoney >
                    _this5.player.gameData.recoveryBoost
                ) {
                  _this5.player.currentMoney =
                    _this5.player.currentMoney -
                    _this5.player.gameData.recoverBoostCost
...
System.register(
  'chunks:///_virtual/HomeSceneController.ts',
  [
    './rollupPluginModLoBabelHelpers.js',
    'cc',
    './HomeCanvasController.ts',
    './HomeLogic.ts',
    './GamercialSceneController.ts'
  ],
  function (exports) {
    var _inheritsLoose,
      cclegacy,
    ...
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          '0a472ffQIRHu4WPEnz+Ie4C',
          'HomeSceneController',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var HomeSceneController = exports(
          'HomeSceneController',
          ((_dec = ccclass('HomeSceneController')),
          _dec(
            (_class = /*#__PURE__*/ (function (_GamercialSceneContro) {
              ...
              function HomeSceneController() {
                ...
                _this =
                  _GamercialSceneContro.call.apply(
                    _GamercialSceneContro,
                    [this].concat(args)
                  ) || this
              ...
              _proto.onSceneLoaded = function onSceneLoaded() {
                ...
                this._homeCanvas =
                  this.node.parent.getComponentInChildren(HomeCanvasController)
                this._homeLogic
                  .doLoadPlayer()
              ...
              _proto.earnByTouch = function earnByTouch() {
                ...
                this._homeLogic.doEarn().then(function (result) {
                  ...
                  _this3._homeCanvas.increaseMoneyBy(
                    _this3._player.currentIncome +
                      _this3._player.gameData.incomeBoost
                  )
                })
              }
...
System.register(
  'chunks:///_virtual/LobbyCanvasController.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc'],
  function (exports) {
    var _applyDecoratedDescriptor,
      _inheritsLoose,
    ...
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          'cd503zAtwxCIrSLLpKzcg2S',
          'LobbyCanvasController',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var LobbyCanvasController = exports(
          'LobbyCanvasController',
          ((_dec = ccclass('LobbyCanvasController')),
          (_dec2 = property({
            type: Node,
            visible: true
          })),
            ...
            (_class =
              ((_class2 = /*#__PURE__*/ (function (_Component) {
                ...
                function LobbyCanvasController() {
                  ...
                  _initializerDefineProperty(
                    _this,
                    '_errorNotificationNode',
                    _descriptor5,
                    _assertThisInitialized(_this)
                  )
                  _initializerDefineProperty(
                    _this,
                    '_errorNotificationText',
                    _descriptor6,
                    _assertThisInitialized(_this)
                  )
                  ...
                  this._loginButton.on(
                    ...
                    function () {
                      ...
                      if (username.length == 0) {
                        ...
                        _this2._errorNotificationText.string =
...
System.register(
  'chunks:///_virtual/LobbySceneController.ts',
  [
    './rollupPluginModLoBabelHelpers.js',
    'cc',
    './GamercialSceneController.ts',
    './LobbyLogic.ts',
    './LobbyCanvasController.ts',
    './GameDirector.ts'
  ],
  function (exports) {
    var _inheritsLoose,
    ...
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          '4556bpHHaFGGauVXcImIaBz',
          'LobbySceneController',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var LobbySceneController = exports(
          'LobbySceneController',
          ((_dec = ccclass('LobbySceneController')),
          _dec(
            (_class = /*#__PURE__*/ (function (_GamercialSceneContro) {
              ...
              _proto.onSceneLoaded = function onSceneLoaded() {
                ...
                this._canvas = this.node.parent.getComponentInChildren(
                  LobbyCanvasController
                )
                if (!this._canvas) {
                  console.log('Cannot found canvas')
                }
                GameDirector.SoundManager()
                  .preloadSoundsClip('lobbyScene')
                  .then(function (result) {
                    GameDirector.SoundManager().playBgm('bgm3')
...
System.register(
  'chunks:///_virtual/LoginDetail.ts',
  ['cc', './User.ts'],
  function (exports) {
    var cclegacy, User
    return {
      ...
      execute: function () {
        cclegacy._RF.push(
          {},
          'a9232jEHtpPMq7T40Xit0Wu',
          'LoginDetail',
          undefined
        )
        var LoginDetail = exports(
          'LoginDetail',
          /*#__PURE__*/ (function () {
...
System.register(
  ...
  [
    ...
    './NetworkManager.ts',
    './NetworkManagerComponent.ts',
    './NetworkManagerConfig.ts',
    './UploadFileInfo.ts',
    './EntryScene.ts',
    './GamercialSceneController.ts',
    './SceneManager.ts',
    './SceneManagerComponent.ts',
    './SceneManagerConfig.ts',
    './SfxButtonController.ts',
    './SfxDestroyWhenEnded.ts',
    './SoundManager.ts',
    './SoundManagerComponent.ts',
    './SoundManagerConfig.ts',
    './IState.ts',
    './StateMachine.ts',
    './MapBlockType.ts',
    './TerrainManager.ts',
    './TerrainManagerComponent.ts',
    './TerrainManagerConfig.ts',
    './UiButtonEvents.ts',
    './AsNode.ts',
    './GameDirector.ts',
    './ISystemBase.ts',
    './MonoSingleton.ts',
    './MonoSingletonConfig.ts',
    './Queue.ts',
    './Game.ts',
    './LoginDetail.ts',
    './Player.ts',
...
System.register(
  'chunks:///_virtual/MapBlockType.ts',
  ['cc'],
  function (exports) {
    var cclegacy
    return {
      ...
      execute: function () {
        ...
        var MapBlockType = exports(
          'MapBlockType',
          /*#__PURE__*/ (function (MapBlockType) {
...
System.register(
  'chunks:///_virtual/MonoSingleton.ts',
  ['cc'],
  function (exports) {
    ...
    return {
      ...
      execute: function () {
        ...
        var MonoSingleton = exports(
          'MonoSingleton',
          ((_dec = ccclass('MonoBehaviour')),
          _dec(
            (_class = /*#__PURE__*/ (function () {
              ...
              _proto.initialize = function initialize(config, onCompleted) {
                ...
                if (config) {
                  ...
                  resources.load(
                    'Gamercial/Config/' + config.configPath,
                    function (err, data) {
                      if (err) {
...
System.register(
  'chunks:///_virtual/MonoSingletonConfig.ts',
  ['cc'],
  function () {
    var cclegacy
    return {
...
System.register(
  ...
  ['./rollupPluginModLoBabelHelpers.js', 'cc', './MonoSingleton.ts'],
  function (exports) {
    var _inheritsLoose,
      _asyncToGenerator,
      _regeneratorRuntime,
    ...
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          '631e2ro3whPmZlLZMsa5ZlQ',
          'NetworkManager',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var NetworkManager = exports(
          'NetworkManager',
          ((_dec = ccclass('NetworkManager')),
          _dec(
            (_class = /*#__PURE__*/ (function (_MonoSingleton) {
              ...
              _proto.sendGrapQlAsync = function sendGrapQlAsync(
                baseUr,
                headers,
                requestBody
              ) {
              ...
              _proto.sendHttpRequest = function sendHttpRequest(
                baseUrl,
                path,
                method,
                headers,
                          ...
                          while (1)
                            switch ((_context.prev = _context.next)) {
                              ...
                              case 11:
                                ...
                                console.log(
                                  'sendHttpRequest response ' + response
                                )
                                if (response.ok) {
                                  _context.next = 20
                                  break
                                ...
                                retrires++
                                if (
                                  !(retrires > _this2._config.max_retry_time)
                                ) {
                                  _context.next = 17
                                  break
                                }
...
System.register(
  'chunks:///_virtual/NetworkManagerComponent.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc'],
  function (exports) {
    var _inheritsLoose, cclegacy, _decorator, Component
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          '14ffcmbz9pB6JPCu5b1O83R',
          'NetworkManagerComponent',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var NetworkManagerComponent = exports(
          'NetworkManagerComponent',
          ((_dec = ccclass('NetworkManagerComponent')),
          _dec(
            (_class = /*#__PURE__*/ (function (_Component) {
...
System.register(
  'chunks:///_virtual/NetworkManagerConfig.ts',
  ['cc'],
  function () {
    var cclegacy
    return {
...
System.register(
  ...
  ['./rollupPluginModLoBabelHelpers.js', 'cc', './User.ts'],
  function (exports) {
...
System.register(
  'chunks:///_virtual/SceneManager.ts',
  [
    './rollupPluginModLoBabelHelpers.js',
    'cc',
    './MonoSingleton.ts',
        ...
        var SceneManager = exports(
          ...
          _dec(
            (_class = /*#__PURE__*/ (function (_MonoSingleton) {
              ...
              _proto.pushSceneWithName = function pushSceneWithName(
                name,
                data
              ) {
                var _this2 = this
                ...
                if (sceneConfig.preloading_assets.length > 0) {
                  for (
                    var pathIndex = 0;
                    pathIndex < sceneConfig.preloading_assets.length;
                    pathIndex++
                  ) {
                    if (
                      sceneConfig.preloading_assets[pathIndex].asset_name ==
                      'prefab'
                    ) {
                      resources.preload(
                        sceneConfig.preloading_assets[pathIndex].asset_path,
                        Prefab
                      )
                    }
                    //add more type later
                ...
                this._component.loadScene(path, function () {
                  ...
                  _this2._currentSceneController =
                    _this2._component.node.parent.getComponentInChildren(
                      GamercialSceneController
                    )
              ...
              _proto.pushSceneWithIndex = function pushSceneWithIndex(
                sceneNumber,
                data
              ) {
                ...
                if (!path) {
                  console.log(
                    'Cannot load scene ' + sceneNumber + ': not found'
                  )
                  return
                }
...
System.register(
  'chunks:///_virtual/SceneManagerComponent.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc'],
  function (exports) {
    ...
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          '2fd850XeSxPjaxwh6W2YNB7',
          'SceneManagerComponent',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var SceneManagerComponent = exports(
          'SceneManagerComponent',
          ((_dec = ccclass('SceneManagerComponent')),
          _dec(
            (_class = /*#__PURE__*/ (function (_Component) {
...
System.register(
  'chunks:///_virtual/SceneManagerConfig.ts',
  ['cc'],
  function () {
    var cclegacy
    return {
...
System.register(
  'chunks:///_virtual/SfxButtonController.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc', './GameDirector.ts'],
  function (exports) {
    var _applyDecoratedDescriptor,
      _inheritsLoose,
      _initializerDefineProperty,
    ...
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          'a0e30T18LpFeav/FjOcwSr2',
          'SfxButtonController',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var SfxButtonController = exports(
          'SfxButtonController',
          ((_dec = ccclass('SfxButtonController')),
          (_dec2 = property({
            visible: true
          })),
          _dec(
...
System.register(
  'chunks:///_virtual/SfxDestroyWhenEnded.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc'],
  function (exports) {
    ...
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          '56f2aBhhdRJ0oB5VkkM4rYd',
          'SfxDestroyWhenEnded',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var SfxDestroyWhenEnded = exports(
          'SfxDestroyWhenEnded',
          ((_dec = ccclass('SfxDestroyWhenEnded')),
          _dec(
            (_class = /*#__PURE__*/ (function (_Component) {
    ...
    return {
      setters: [
        function (module) {
          _inheritsLoose = module.inheritsLoose
          _createForOfIteratorHelperLoose =
            module.createForOfIteratorHelperLoose
        },
        function (module) {
          cclegacy = module.cclegacy
          _decorator = module._decorator
            ...
            (_class = /*#__PURE__*/ (function (_MonoSingleton) {
              ...
              _proto.preloadSoundsClip = function preloadSoundsClip(groupName) {
                ...
                return new Promise(function (resolve, reject) {
                  ...
                  for (
                    var _iterator = _createForOfIteratorHelperLoose(group.bmg),
                      _step;
                  ...
                  for (
                    var _iterator2 = _createForOfIteratorHelperLoose(group.sfx),
                      _step2;
              ...
              _proto.setSfxVolume = function setSfxVolume(volume) {
                for (
                  var sfxindex = 0;
                  sfxindex < this._sfxAudioSource.length;
                  sfxindex++
                ) {
...
System.register(
  'chunks:///_virtual/SoundManagerComponent.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc'],
  function (exports) {
    var _inheritsLoose, cclegacy, _decorator, Component
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          'ec39a/MzKFJ5KJow06HuKaD',
          'SoundManagerComponent',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var SoundManagerComponent = exports(
          'SoundManagerComponent',
          ((_dec = ccclass('SoundManagerComponent')),
          _dec(
            (_class = /*#__PURE__*/ (function (_Component) {
...
System.register(
  'chunks:///_virtual/SoundManagerConfig.ts',
  ['cc'],
  function () {
    var cclegacy
    return {
...
System.register(
  'chunks:///_virtual/StateMachine.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc'],
  function (exports) {
    var _applyDecoratedDescriptor,
      _inheritsLoose,
            ...
            (_class =
              ((_class2 = /*#__PURE__*/ (function (_Component) {
                ...
                _proto.onUpdate = function onUpdate(dt) {
                  if (
                    !this._currentState &&
                    this._states[this._defaultStateName]
                  ) {
...
System.register(
  'chunks:///_virtual/TerrainManager.ts',
  [
    './rollupPluginModLoBabelHelpers.js',
    'cc',
    './MonoSingleton.ts',
    ...
    return {
      ...
      execute: function () {
        ...
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var blockDictionary = {}
        var TerrainManager = exports(
          'TerrainManager',
          ((_dec = ccclass('TerrainManager')),
          _dec(
            (_class = /*#__PURE__*/ (function (_MonoSingleton) {
              ...
              _proto.randomFill = function randomFill() {
                ...
                return new Promise(function (resolve, reject) {
                  var noiseMap = []
                  var randomColumn =
                    Math.floor(Math.random() * (_this2._config.width - 8)) + 4
                  for (var y = 0; y < _this2._config.height; y++) {
                    ...
                    for (var x = 0; x < _this2._config.width; x++) {
                      if (
                        x === 0 ||
                        y === 0 ||
                        x === _this2._config.width - 1 ||
                        y === _this2._config.height - 1
                      ) {
                        ...
                        Math.random() * 100 >
                        _this2._config.noise_map.frequency
                      ) {
                        row.push(MapBlockType.WALL)
                      } else {
                        row.push(MapBlockType.FLOOR)
              ...
              _proto.generateCellularAutomationMap =
                function generateCellularAutomationMap(input) {
                  var _this3 = this
                  return new Promise(function (resolve, reject) {
              ...
              _proto.countAdjacentWalls = function countAdjacentWalls(
                input,
                x,
                y
              ) {
                ...
                for (var y = 0; y < this._config.height; y++) {
                  ...
                  for (var x = 0; x < this._config.width; x++) {
                    ...
                    if (input[y][x] == MapBlockType.WALL) {
                      row.push(MapBlockType.WALL)
                      for (
                        var checkSideIndex = 0;
                        checkSideIndex < checkSize.length;
                        checkSideIndex++
                      ) {
                        if (
                          this.checkIsNotContainWallInFindMap(
                            input,
                            checkSize[checkSideIndex],
                            x,
                            y
                          )
                        ) {
              ...
              _proto.checkIsNotContainWallInFindMap =
                function checkIsNotContainWallInFindMap(input, map, x, y) {
                  for (var j = -1; j < 2; j++) {
                    for (var i = -1; i < 2; i++) {
                      if (
                        input[j + y][i + x] == MapBlockType.WALL &&
                        map[j + 1][i + 1] == 1
                      ) {
                        return false
                      }
              ...
              _proto.placeWallLogic = function placeWallLogic(map, x, y) {
                ...
                return (
                  this.countAdjacentWalls(map, x, y) >=
                    this._config.wall_limit ||
                  x < this._config.boundary ||
                  x > this._config.width - this._config.boundary ||
                  y < this._config.boundary ||
                  y > this._config.height - this._config.boundary
                  ...
                  for (var _j = 0; _j < map.length; _j++) {
                    ...
                    for (var _i = 0; _i < map[0].length; _i++) {
                      if (map[_j][_i] == MapBlockType.FLOOR) {
                        ...
                        if (
                          Math.pow(baselocationY - _j, 2) +
                            Math.pow(baselocationX - _i, 2) <
                          Math.pow(_this4._config.home_size * 1.5, 2)
                        ) {
                          row.push(MapBlockType.FLOOR)
              ...
              _proto.createToughnessMap = function createToughnessMap(
                sourceMap
              ) {
                return new Promise(function (resolve, reject) {
                  try {
              ...
              _proto.putCampPlace = function putCampPlace(map) {
                ...
                return new Promise(function (resolve, reject) {
                  ...
                  for (
                    var j = campY - _this5._config.home_size;
                    j < campY;
                    j++
                  ) {
                    for (
                      var i = campX - _this5._config.home_size;
                      i < campX;
                      i++
                    ) {
                      map[j][i] = MapBlockType.BASE
              ...
              _proto.findAvaiableArena = function findAvaiableArena(map) {
                ...
                for (var _j3 = 2; _j3 < map.length; _j3++) {
                  for (var _i2 = 2; _i2 < map.length; _i2++) {
                    if (
                      map[_j3][_i2] == map[_j3 - 1][_i2] &&
                      map[_j3][_i2] == map[_j3][_i2 - 1] &&
                      map[_j3 - 1][_j3] &&
                      map[_j3][_i2] != MapBlockType.WALL
                    ) {
                      fMap[_j3][_i2] =
                        Math.min(
                          fMap[_j3 - 1][_i2],
                          Math.min(fMap[_j3][_i2 - 1], fMap[_j3 - 1][_i2 - 1])
                        ) + 1
                    } else {
                      fMap[_j3][_i2] = 1
                    }
              ...
              _proto.initPrefab = function initPrefab() {
                ...
                return new Promise(function (resolve, reject) {
                  ...
                  var _loop = function _loop(blockPrefabIndex) {
                    resources.load(
                      _this6._config.blocks[blockPrefabIndex].path,
                      Prefab,
                      function (err, blockPrefab) {
                        if (err) {
                          console.error(
                            'Cannot load prefab ' +
                              _this6._config.blocks[blockPrefabIndex].path +
                          ...
                          console.log(
                            'Load prefab ' +
                              _this6._config.blocks[blockPrefabIndex].name
                          )
                          blockDictionary[
                            _this6._config.blocks[blockPrefabIndex].type_index
                          ] = blockPrefab
                        }
                        resourceLoaded++
                  ...
                  for (
                    ...
                    blockPrefabIndex < _this6._config.blocks.length;
                    blockPrefabIndex++
                  ) {
...
System.register(
  'chunks:///_virtual/TerrainManagerComponent.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc'],
  function (exports) {
    var _inheritsLoose, cclegacy, _decorator, Component
    return {
      ...
      execute: function () {
        ...
        cclegacy._RF.push(
          {},
          'b27b8Eq3s1M7LFJv61+qLzq',
          'TerrainManagerComponent',
          undefined
        )
        var ccclass = _decorator.ccclass,
          property = _decorator.property
        var TerrainManagerComponent = exports(
          'TerrainManagerComponent',
          ((_dec = ccclass('TerrainManagerComponent')),
          _dec(
            (_class = /*#__PURE__*/ (function (_Component) {
...
System.register(
  'chunks:///_virtual/TerrainManagerConfig.ts',
  ['cc'],
  function () {
    var cclegacy
    return {
...
System.register(
  'chunks:///_virtual/UiButtonEvents.ts',
  ['./rollupPluginModLoBabelHelpers.js', 'cc'],
  function (exports) {
    var _applyDecoratedDescriptor,
      _initializerDefineProperty,
    ...
    return {
      ...
      execute: function () {
        ...
        var Action = exports(
          'Action',
          /*#__PURE__*/ (function (Action) {
            Action[(Action['ACTIVE'] = 0)] = 'ACTIVE'
            Action[(Action['INACTIVE'] = 1)] = 'INACTIVE'
            return Action
          })({})
        )
        var ButtonEvent = exports(
          'ButtonEvent',
          ((_dec = ccclass('ButtonEvent')),
          (_dec2 = property({
            type: Enum(Key)
          })),
          (_dec3 = property({
        ...
        var UiButtonEvents = exports(
          'UiButtonEvents',
          ((_dec5 = ccclass('UiButtonEvents')),
          (_dec6 = property(ButtonEvent)),
          _dec5(
            (_class4 =
              ((_class5 = /*#__PURE__*/ (function (_Component) {
...
System.register(
  'chunks:///_virtual/UploadFileInfo.ts',
  ['cc'],
  function (exports) {
    var cclegacy
    return {
      ...
      execute: function () {
        cclegacy._RF.push(
          {},
          '5cd62MNKVJDsY4ihTu9M0/M',
          'UploadFileInfo',
          undefined
        )
        var UploadImageDataType = exports(
          'UploadImageDataType',
          /*#__PURE__*/ (function (UploadImageDataType) {
            UploadImageDataType[(UploadImageDataType['FILE_DATA'] = 0)] =
              'FILE_DATA'
            UploadImageDataType[(UploadImageDataType['FILE_PATH'] = 1)] =
              'FILE_PATH'
            return UploadImageDataType
          })({})
        )
        var UploadFileInfo = exports(
          'UploadFileInfo',
          function UploadFileInfo(type, data) {
            this._type = void 0
            this._data = void 0
            this._data = data
            this._type = type
